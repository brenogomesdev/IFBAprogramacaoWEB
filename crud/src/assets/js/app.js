...
function updateProduct(productId, product) {
    if (
        ...
        //Atualiza a lista contendo o atualizado
        updateTable()
    } else {
...
function deleteProduct(productId) {
    const confirmDelete = confirm(`Tem certeza que deseja excluir o registro de ID: ${productId}`)
    if (confirmDelete) {
        productCrud.deleteProduct(productId)

        //Atualiza a lista contendo os produtos restantes
        updateTable()
    }
...
updateProductBtn.addEventListener('click', function () {
    const producNameInput = document.getElementById('updateProductName')
    const producPriceInput = document.getElementById('updateProductPrice')
    const producQtdInput = document.getElementById('updateProductQtd')

    updateProduct(productId, {
        updateName: producNameInput.value,
        updatePrice: producPriceInput.value,
        updateQtd: producQtdInput.value,
    })
